...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#e68f3a05#;
   ...
   u00132 : constant Version_32 := 16#c343cc8a#;
   pragma Export (C, u00132, "icdB");
   u00133 : constant Version_32 := 16#80c7b8e2#;
   pragma Export (C, u00133, "icdS");
   u00134 : constant Version_32 := 16#34a19a2a#;
   pragma Export (C, u00134, "heartB");
   u00135 : constant Version_32 := 16#34b37eac#;
   pragma Export (C, u00135, "heartS");
   u00136 : constant Version_32 := 16#17bda97a#;
   pragma Export (C, u00136, "measuresB");
   u00137 : constant Version_32 := 16#ab0ff7ab#;
   pragma Export (C, u00137, "measuresS");
   u00138 : constant Version_32 := 16#1d885ae5#;
   pragma Export (C, u00138, "randomnumberB");
   u00139 : constant Version_32 := 16#f8c8aef0#;
   pragma Export (C, u00139, "randomnumberS");
   u00140 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00140, "ada__numericsS");
   u00141 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00141, "ada__numerics__elementary_functionsB");
   u00142 : constant Version_32 := 16#c6ca7006#;
   pragma Export (C, u00142, "ada__numerics__elementary_functionsS");
   u00143 : constant Version_32 := 16#e5114ee9#;
   pragma Export (C, u00143, "ada__numerics__auxB");
   u00144 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00144, "ada__numerics__auxS");
   u00145 : constant Version_32 := 16#36373acb#;
   pragma Export (C, u00145, "system__fat_llfS");
   u00146 : constant Version_32 := 16#5fc82639#;
   pragma Export (C, u00146, "system__machine_codeS");
   u00147 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00147, "system__exn_llfB");
   u00148 : constant Version_32 := 16#8ede3ae4#;
   ...
   u00151 : constant Version_32 := 16#62aa8dd2#;
   pragma Export (C, u00151, "ada__numerics__float_randomS");
   u00152 : constant Version_32 := 16#d34f9f29#;
   pragma Export (C, u00152, "system__random_numbersB");
   u00153 : constant Version_32 := 16#f1b831a2#;
   pragma Export (C, u00153, "system__random_numbersS");
   u00154 : constant Version_32 := 16#40a8df0e#;
   pragma Export (C, u00154, "system__random_seedB");
   u00155 : constant Version_32 := 16#69b0a863#;
   pragma Export (C, u00155, "system__random_seedS");
   u00156 : constant Version_32 := 16#0d7f1a43#;
   pragma Export (C, u00156, "ada__calendarB");
   u00157 : constant Version_32 := 16#5b279c75#;
   pragma Export (C, u00157, "ada__calendarS");
   u00158 : constant Version_32 := 16#a99e1d66#;
   pragma Export (C, u00158, "system__os_primitivesB");
   u00159 : constant Version_32 := 16#b82f904e#;
   pragma Export (C, u00159, "system__os_primitivesS");
   u00160 : constant Version_32 := 16#b6166bc6#;
   pragma Export (C, u00160, "system__task_lockB");
   u00161 : constant Version_32 := 16#532ab656#;
   pragma Export (C, u00161, "system__task_lockS");
   u00162 : constant Version_32 := 16#1a9147da#;
   pragma Export (C, u00162, "system__win32__extS");
   u00163 : constant Version_32 := 16#8b74a921#;
   pragma Export (C, u00163, "networkB");
   u00164 : constant Version_32 := 16#ed9a5ee9#;
   pragma Export (C, u00164, "networkS");
   u00165 : constant Version_32 := 16#9094876d#;
   pragma Export (C, u00165, "ada__assertionsB");
   u00166 : constant Version_32 := 16#1a0b0d2c#;
   pragma Export (C, u00166, "ada__assertionsS");
   u00167 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00167, "system__assertionsB");
   u00168 : constant Version_32 := 16#ff2dadac#;
   pragma Export (C, u00168, "system__assertionsS");
   u00169 : constant Version_32 := 16#2bf99b12#;
   pragma Export (C, u00169, "principalB");
   u00170 : constant Version_32 := 16#ba98eec4#;
   pragma Export (C, u00170, "principalS");
   u00171 : constant Version_32 := 16#18e0e51c#;
   pragma Export (C, u00171, "system__img_enum_newB");
   u00172 : constant Version_32 := 16#53ec87f8#;
   ...
   u00176 : constant Version_32 := 16#6bdde70c#;
